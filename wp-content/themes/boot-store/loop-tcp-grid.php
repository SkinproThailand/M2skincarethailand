...
<?php if ( ! have_posts() ) : ?>
	<article id="post-0" class="post no-results not-found">
		...
		<div class="entry-content">
			<p>
				<?php _e( 'Apologies, but no results were found for the requested archive. Perhaps searching will help find a related post.', 'bre-bootstrap-ecommerce' ); ?>
			</p>
			<?php get_search_form(); ?>
		</div><!-- .entry-content -->
	</article><!-- #post-0 -->
...
<?php while ( have_posts() ) : the_post();
	...
	<?php $column--;?>
		...
		<div class="entry-content clearfix">
			<?php the_content( __( 'More <span class="meta-nav">&rarr;</span>', 'bre-bootstrap-ecommerce' ) ); ?>
			<?php wp_link_pages( array( 'before' => '<div class="page-link">' . __( 'Pages:', 'bre-bootstrap-ecommerce' ), 'after' => '</div>' ) ); ?>
		</div><!-- .entry-content -->
		<?php endif; ?>
		...
		<?php if ( $see_author ) :?>
			<div class="entry-author-info media clearfix">
				...
				<div class="author-description media-body">
					<p class="author-user"><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php printf( esc_attr__( 'By %s', 'bre-bootstrap-ecommerce' ), get_the_author_meta('display_name') ); ?></a></p>
		...
		<?php if ( $see_meta_utilities ) : ?>
			...
			<?php if ( comments_open() ) : ?>
				...
				<span class="comments-link"><?php comments_popup_link( '<span class="leave-reply">' . __( 'Leave a review', 'bre-bootstrap-ecommerce' ) . '</span>', __( '<b>1</b> Review', 'bre-bootstrap-ecommerce' ), __( '<b>%</b> Reviews', 'bre-bootstrap-ecommerce' ) ); ?></span>
