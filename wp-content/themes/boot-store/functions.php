...
?>
<script>
/* Bse nav_menus in sidebar */
<?php if ( $tcp_bse_sidebar_style ) { ?>
...
add_action( 'wp_footer', 'bre_wp_footer' );
...
function bre_tcp_get_setting( $value, $setting_name, $default_value ) {
	...
	if ( 'load_default_loop_style' == $setting_name ) return false;
	return $value;
}
