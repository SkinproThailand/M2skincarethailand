...
<?php if ( ! have_posts() ) : ?>
	<article id="post-0" class="post no-results not-found">
		...
		<div class="entry-content">
			<p><?php _e( 'Apologies, but no results were found for the requested archive. Perhaps searching will help find a related post.', 'bre-bootstrap-ecommerce' ); ?></p>
			<?php get_search_form(); ?>
		</div><!-- .entry-content -->
	</article><!-- #post-0 -->
<?php endif; ?>
...
<div class="tcp_products_list tcp_products_list_bs">

<?php while ( have_posts() ) : the_post(); ?>

	<div class="row-fluid post-<?php the_ID(); ?>">
		<?php if ( $see_image ) : ?>
			<div class="media span2">
				<?php if (has_post_thumbnail()) :  ?>
							<div class="entry-post-thumbnail">
								<a class="tcp_size-<?php echo $image_size;?> media-object" href="<?php the_permalink(); ?>"><?php if ( function_exists( 'the_post_thumbnail' ) ) the_post_thumbnail($image_size); ?></a>
		...
		<?php endif; ?>
				<article <?php post_class(); ?>>
					...
					<?php if ( $see_title ) : ?>
						<?php echo $title_tag;?><a href="<?php the_permalink( );?>" class="media-heading"><?php the_title(); ?></a>
					...
					<?php if ( $see_meta_utilities ) : ?>
						...
						<span class="comments-link btn btn-small"><?php comments_popup_link( '<span class="leave-reply">' . __( 'Leave a review', 'bre-bootstrap-ecommerce' ) . '</span>', __( '<b>1</b> Review', 'bre-bootstrap-ecommerce' ), __( '<b>%</b> Reviews', 'bre-bootstrap-ecommerce' ) ); ?></span>
