		...
		<div class="postbox">
			<div class="inside">
				...
				<tr valign="top">
					...
					<td>
						<input type="text" name="bre_label_a" value="<?php echo get_option( 'bre_label_a', '' ); ?>" />
					</td>
				</tr>
				<tr valign="top">
					<th scope="row">
					...
					<td>
						<textarea name="bre_description_a" cols="80" rows="5"><?php echo get_option( 'bre_description_a', '' ); ?></textarea>
					</td>
				</tr>
				</tbody>
				</table>
		...
		<div class="postbox">
			<div class="inside">
				...
				<tr valign="top">
					...
					<td>
						<input type="text" name="bre_label_b" value="<?php echo get_option( 'bre_label_b', '' ); ?>" />
					</td>
				</tr>
				<tr valign="top">
					<th scope="row">
						<label><?php _e( 'Description', 'bre-bootstrap-ecommerce' ); ?>:</label>
					<td>
						<textarea name="bre_description_b" cols="80" rows="5"><?php echo get_option( 'bre_description_b', '' ); ?></textarea>
					</td>
				</tr>
				</tbody>
				</table>
		...
		<div class="postbox">
			<div class="inside">
				...
				<tr valign="top">
					...
					<td>
						<input type="text" name="bre_label_c" value="<?php echo get_option( 'bre_label_c', '' ); ?>" />
					</td>
				</tr>
				<tr valign="top">
					<th scope="row">
						<label><?php _e( 'Description', 'bre-bootstrap-ecommerce' ); ?>:</label>
					<td>
						<textarea name="bre_description_c" cols="80" rows="5"><?php echo get_option( 'bre_description_c', '' ); ?></textarea>
					</td>
				</tr>
				</tbody>
				</table>
...
function bre_the_three_boxes( $echo = true ) { 
	ob_start(); ?>
<div class="row-fluid" >
	<ul class="thumbnails home-boxes">
		<li class="span4 box box-left">
