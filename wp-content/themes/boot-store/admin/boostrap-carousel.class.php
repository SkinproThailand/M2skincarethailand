...
class BREBoostrapCarouselMetabox {
	...
	static function bre_carousel_meta_box( $post ) { 
		...
		<p>
			<label for="bre_add_to_home_carousel"><?php _e( 'Add to carousel of carousel template', 'bre-bootstrap-ecommerce' ); ?></label>
		...
		<p>
			<label for="bre_add_to_home_carousel"><?php _e( 'Image to add', 'bre-bootstrap-ecommerce' ); ?>:</label>
			<br/>
